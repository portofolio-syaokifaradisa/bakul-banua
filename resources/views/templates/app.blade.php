...
<body>
  <div id="app">
    <div class="main-wrapper">
      ...
      <div class="main-sidebar sidebar-style-2 pt-3">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{ route('home') }}">Bakul Banua</a>
          </div>
      ...
      <footer class="main-footer">
        <div class="footer-right">
            Developed By &copy; <a href="https://erabits-indonesia.com/">Era Bits Indonesia 2023</a> 
        </div>
      </footer>
    </div>
  </div>
