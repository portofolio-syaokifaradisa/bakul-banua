...
@section('content')
  ...
  <div class="card">
    ...
    <form
      action="{{ URLHelper::has('edit') ? route('umkm.product.update', ['product_id' => $product->id, 'umkm_id' => $umkm_id]) : route('umkm.product.store', ['umkm_id' => $umkm_id]) }}"
      ...
      <div class="card-footer text-right">
        <a href="{{ route('umkm.detail', ['umkm_id' => $umkm_id]) }}" class="btn btn-secondary px-3 mr-1"><i class="fas fa-times mr-1"></i> Batal</a>
