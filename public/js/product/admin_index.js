    ...
    const table = $("#product-datatable").dataTable({
        ...
        columns: [
            ...
            { 
                ...
                orderable: false, 
                searchable: false,
                render: function(productId, type, order, meta){
                    ...
                    return `
                        <div class="btn-group dropright px-0 pr-2">
                            ...
                            <div class="dropdown-menu dropright">
                                <a class="dropdown-item has-icon" href="${baseUrl}/${productId}/edit">
            ...
            { 
                ...
                render: function(pictures, type, order, meta){
                    ...
                    for(var i=0; i < pictures.length; i++){
                        element += `
                            <a href="${pictures[i]}" target="_blank">Foto Produk ${i + 1}</a><br>
                        `;
                    }
